...
def calculates_results_stats(results_dic):
    ...
    n_dogs_img = len(list(res for res in results_dic.values() if res[3] == 1))
    n_notdogs_img = len(list(res for res in results_dic.values() if res[3] == 0))
    n_match = len(list(res for res in results_dic.values() if res[2] == 1))
    n_correct_dogs = len(list(res for res in results_dic.values() if res[3] == 1 and res[4] == 1))
    n_correct_notdogs = len(list(res for res in results_dic.values() if res[3] == 0 and res[4] == 0))
    n_correct_breed = len(list(res for res in results_dic.values() if res[2] == 1 and res[3] == 1))
    if n_images == 0:
        pct_match = 0
    else:
